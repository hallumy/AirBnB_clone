...
class Test_BaseModel(unittest.TestCase):                                      
    """tests All files, classes                                               
    functions in BaseModel class                                              
    """                                                                       
    @classmethod                                                              
    def setUpClass(cls):                                                      
        """                                                                   
        Setup testing framework will                                          
        call for every single test we run                                     
        """                                                                   
        Cls.base = inspect.getmembers(BaseModel, inspect.isfunction)          
    ...
    def test_pep8_BaseModel(self):
        ...
        pyStyle = style.check_files([‘models/base_model.py’])
        self.assertEqual(pyStyle.total_errors, 0, “fix pep8”)
    """
    ...
    def test__str__BaseModel(self):
        ...
        """
        String = str(self.BM)
        BMid = '[{}] ({}) {}'.format(self.BM._class_._name_, self.BM.id, self.BM.__dict__)
    ...
    def test_id__type__str(self):
        ...
        self.assertEqual([self.BM.id], str)
